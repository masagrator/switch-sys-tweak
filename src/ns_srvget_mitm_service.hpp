...
#define NS_RO_APP_CONTROL_DATA_INTERFACE_INFO(C, H) \
	...
	AMS_SF_METHOD_INFO_F(C, H, NsROAppControlDataInterfaceCmdId, Unk16, (sf::OutCopyHandle out_handle, ams::sf::Out<sf::SharedPointer<IAsyncResult>> out_interface), (out_handle, out_interface)) \
